...
def run_and_submit_all():
    username = "nuha-alharbi10"
    api_url = DEFAULT_API_URL

    questions_url = f"{api_url}/questions"
    submit_url = f"{api_url}/submit"

    agent = FinalGaiaAgent()
    ...
    for item in questions:
        ...
        submitted_answer = agent(task_id, question)
    ...
    space_id = os.getenv("SPACE_ID", "nuha-alharbi10/gaia-final-agent")
...
with gr.Blocks() as demo:
    ...
    gr.Markdown(
        "This app submits my final GAIA assignment answers for the Hugging Face Agents Course."
    )

    run_button = gr.Button("Run Evaluation and Submit Answers")
